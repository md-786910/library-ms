            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                >
                    <Link to="/" className="flex items-center">
                        ...
                        <span className="ml-3 text-2xl font-bold text-gray-900">LibrarySpace</span>
                    </Link>
                </motion.div>
                        ...
                        <div className="mt-1">
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="focus:ring-indigo-500 focus:border-indigo-500 block w-full px-3 sm:text-sm border-gray-300 rounded-md"
